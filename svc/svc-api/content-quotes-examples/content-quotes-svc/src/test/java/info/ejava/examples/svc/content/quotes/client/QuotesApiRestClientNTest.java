...
@Tag("springboot")
@Slf4j
public class QuotesApiRestClientNTest {
    @Autowired
    private QuoteDTOFactory quotesFactory;
    @Autowired @Qualifier("restClientApi")
    private QuotesAPIRestClient quotesApiRestClient;
    @Autowired
    private URI baseUrl;
    ...
    public void setUp() {
        ...
        quotesApiRestClient.deleteAllQuotes();
    }
    ...
    public void add_valid_quote() {
        ...
        //when - added to the service
         ResponseEntity<QuoteDTO> response = quotesApiRestClient.createQuote(validQuote);
    ...
    private QuoteDTO given_an_existing_quote() {
        ...
        ResponseEntity<QuoteDTO> quoteResponse = quotesApiRestClient.createQuote(existingQuote);
    ...
    public void update_existing_quote() {
        ...
        ResponseEntity<Void> response = quotesApiRestClient.updateQuote(requestId, updatedQuote);

        //then - no exception was thrown and ...
        then(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        ResponseEntity<QuoteDTO> quoteResponse = quotesApiRestClient.getQuote(requestId);
    ...
    public void get_quote() {
        ...
        ResponseEntity<QuoteDTO> response = quotesApiRestClient.getQuote(requestId);
    ...
    protected List<QuoteDTO> given_many_quotes(int count) {
        ...
        for (QuoteDTO quote: quotesFactory.listBuilder().quotes(count, count)) {
            ResponseEntity<QuoteDTO> response = quotesApiRestClient.createQuote(quote);
...
//                .flatMap(quote -> quotesApiRestClient.createQuote(quote) )
...
//                .block();
    ...
    public void get_random_quote() {
        ...
        //then
        ResponseEntity<QuoteDTO> response = quotesApiRestClient.randomQuote();
    ...
    public void remove_quote() {
        ...
        assertThat(quotesApiRestClient.getQuote(requestId).getStatusCode()).isEqualTo(HttpStatus.OK);

        //when - requested to remove
        ResponseEntity<Void> response = quotesApiRestClient.deleteQuote(requestId);

        //then
        then(response.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.getQuote(requestId),
    ...
    public void remove_all_quotes() {
        ...
        ResponseEntity<Void> response = quotesApiRestClient.deleteAllQuotes();

        //then - map should be cleared
        then(response.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);
        for (QuoteDTO quote: quotes) {
            RestClientResponseException ex = catchThrowableOfType(
                    ()->quotesApiRestClient.containsQuote(quote.getId()),
                    RestClientResponseException.class);
            assertThat(ex.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
        }
    }
    ...
    public void get_random_quote_no_quotes() {
        //given - no quotes
        assertThat((quotesApiRestClient.deleteAllQuotes()).getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);

        //then
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.randomQuote(),
                RestClientResponseException.class);
    ...
    public void get_unknown_quote() {
        ...
        //when - requesting quote by id
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.getQuote(unknownId),
                RestClientResponseException.class);
    ...
    public void update_unknown_quote() {
        ...
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.updateQuote(unknownId, updatedQuote),
                RestClientResponseException.class);
    ...
    public void update_known_quote_with_bad_quote() {
        ...
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.updateQuote(knownId, badQuoteMissingText),
                RestClientResponseException.class);
    ...
    public void add_bad_quote_rejected() {
        ...
        //verify
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.createQuote(badQuoteMissingText),
                RestClientResponseException.class);
    ...
    public void get_invalid_offset_limit(
        ...
        RestClientResponseException ex = catchThrowableOfType(
                ()->quotesApiRestClient.getQuotes(offset, limit),
                RestClientResponseException.class);
    ...
    public void get_empty_quotes() {
        ...
        ResponseEntity<QuoteListDTO> response = quotesApiRestClient.getQuotes(0, 100);
        log.debug("{}", response);
    ...
    public void get_many_quotes() {
        ...
        ResponseEntity<QuoteListDTO> response = quotesApiRestClient.getQuotes(10, 10);
