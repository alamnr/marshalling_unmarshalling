...
/*
 * This is a demonstration Aspect, with avariety of point cuts and advice 
...
@Aspect
@Slf4j
@ConditionalOnProperty(name = "enable.example.aspects", havingValue = "true", matchIfMissing = true)
public class ItemsAspect {
    ...
    public void beforServiceMethod(JoinPoint jp){
        log.info("======================================= beforeserviceMethod: {}", jp);
    }

    // ===================================

    @Pointcut("args(info.ejava.examples.svc.aop.items.dto.GrillDTO)")  // pointcut predicate 0r expression
